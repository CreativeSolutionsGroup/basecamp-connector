...
declare global {
  interface Window {
    Trix?: {
      Attachment: new (params: TrixAttachment) => TrixAttachment;
    };
  }
}
...
const TrixEditor = forwardRef<TrixEditorHandle, TrixEditorProps>(
  function TrixEditor(
    ...
    useImperativeHandle(ref, () => ({
      ...
      insertPlaceholder: (questionId: string, title: string) => {
        ...
        editorRef.current.editor.insertAttachment(
          new TrixAttachmentClass({
            content,
            contentType: "application/vnd.field-chip",
          }),
        );
      },
    }));
